(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/0604/8635/3036/t/9/assets/appstle-subscription.js?v=1688388521");
      ...
      RS.Config = {
        ...
        "shop": "flawlessbody-shop.myshopify.com",
	...
	"webhookAccess": false
        ...
        "css": {
            ...
            "customCSS": "",
            "elementCSS": "[\".appstle_subscription_final_price { color: #553369 !important;}\",\"#appstle_subscription_widget0.appstle_subscription_wrapper.appstle_select {border-style: #553369 !important;}\"]",
            "customerPortalCss": "",
